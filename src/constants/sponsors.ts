...
export const goodsSponsors: GoodsSponsor[] = [
  {
    name: "富永貿易株式会社",
    image: {
      src: "/images/sponsors/tominaga.jpg",
      width: 1024,
      height: 561,
      alt: "富永貿易株式会社 ロゴ",
    },
    paragraphs: [
      "1923年に神戸で創業した富永貿易は、100年以上にわたり、この街とともに歩んできました。\n私たちは、商品を生み出すメーカーとして、そして世界中の魅力ある商品や人を結ぶ商社として、\n食を通じてたくさんの出会いをつくってきました。",
      "「おいしい出会いを、つぎつぎと。」\nこの言葉には、食を通じて新しいものを生み出すこと、人と人、想いと想いをつなぐこと、\nそして、そこから生まれるワクワクをもっと多くの人へ届けたい、という私たちの想いが込められています。",
      "音楽をきっかけに人が集まり、つながり、学生の皆さんの「やってみたい」という想いが、新しい文化や街のワクワクへと広がっていく。\nそんな神戸音学祭の姿に、私たちは強く共感しています。",
      "食も、音楽も、人と人をつなぎ、新しい出会いや心が動く瞬間を生み出すもの。\nこれまで私たちを育ててくれた神戸への感謝を胸に、神戸音学祭から素敵な出会いと新しい可能性が\n\u201cつぎつぎと\u201d生まれていくことを願って。",
      "富永貿易は、神戸音学祭と、次の世代の皆さんの挑戦を応援しています！",
    ],
  },
  {
    name: "トーラク株式会社",
