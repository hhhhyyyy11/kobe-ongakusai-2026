...
const faqItems = [
  ...
  {
    question: "出演団体やタイムテーブルはどこで確認できますか？",
    answer:
      "出演団体は出演団体ページ、当日の出演順はタイムテーブルページで公開しています。タイムテーブルから各団体の公式SNSも確認できます。",
  },
];
            ...
            <div className="mb-12 grid gap-8 lg:grid-cols-2">
              ...
              <section className="rounded-3xl border-4 border-kobe-dark-teal bg-white p-8 shadow-xl">
                ...
                <div className="space-y-4 text-kobe-dark-teal">
                  ...
                  <p className="font-bold leading-relaxed">
                    出演団体、タイムテーブル、ブース詳細は各ページで公開中です。タイムテーブルから各出演団体の公式SNSも確認できます。
                  </p>
                </div>
              </section>
            </div>
