        ...
        <div className="max-w-5xl mx-auto bg-white rounded-3xl border-6 border-kobe-dark-teal shadow-2xl px-4 py-8 sm:p-6 md:p-8 lg:p-10">
          <div className="flex flex-col items-center gap-6">
            ...
            <div className="grid w-full items-center justify-center gap-8 lg:grid-cols-[minmax(280px,360px)_minmax(310px,362px)] lg:gap-12">
              ...
              <div className="mx-auto flex w-full max-w-[362px] flex-col items-center text-center">
                <div className="flex min-h-[414px] w-full max-w-[348px] items-center justify-center overflow-hidden rounded-2xl border-2 border-kobe-dark-teal bg-orange-50 p-2 shadow-xl sm:min-h-[459px] sm:border-4 sm:p-4 md:min-h-[495px] md:max-w-[362px]">
